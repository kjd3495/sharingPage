    ...
    return (
        ...
        <div className="create_content">
            ...
            <div className="create">
                ...
                <div className="create_inputField"><input type="email" name="user_email" id="email" placeholder="이메일을 입력해 주세요" value={email} onChange={(e)=>{setEmail(e.target.value)}}/></div><button type="submit" onClick={emailCheck} className="emailCheck_btn">중복확인</button>
                ...
                <div className="create_inputField"><input type="nickname"name="user_nickname" id="nickname" placeholder="닉네임을 입력해 주세요." value={nickname} onChange={(e)=>{setNickname(e.target.value)}}/></div><button type="submit" onClick={nicknameCheck} className="nicknameCheck_btn">중복확인</button>
